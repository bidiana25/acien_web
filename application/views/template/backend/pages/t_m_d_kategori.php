        ...
        <tbody>
          ...
          foreach ($c_t_m_d_kategori as $key => $value) 
          {
            if($value->MARK_FOR_DELETE == 'f')
            {
              ...
              echo "<a href='".site_url('c_t_m_d_kategori/delete/' . $value->ID)."' ";
              ?>
            ...
            if($value->MARK_FOR_DELETE == 't')
            {
              ...
              echo "<a href='".site_url('c_t_m_d_kategori/undo_delete/' . $value->ID)."' ";
              ?>
...
<!-- MODAL TAMBAH Beban! !-->
<form action="<?php echo base_url('c_t_m_d_kategori/tambah') ?>" method="post">
        ...
        <div class="modal-body">
          <div class="">
            ...
            <div class="form-group">
              ...
              <input type='text' class='form-control' placeholder='Input Text' name='kategori'>
            </div>
...
<div class="modal fade" id="Modal_Edit" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <form action="<?php echo base_url('c_t_m_d_kategori/edit_action') ?>" method="post">
      <div class="modal-content">
        <div class="modal-header">
...
<script>
  const users = <?= json_encode($c_t_m_d_kategori) ?>;
  console.log(users);
