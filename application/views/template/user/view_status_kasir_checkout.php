        ...
        <div class="col-lg-6 content order-lg-1 order-2">
          ...
          <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
            ...
            <form action="<?php echo base_url('status_kasir/checkout') ?>" method="post">
              ...
              <br /><br />
              <button style="margin-left: 100px;" type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#myModal">Batalkan Transaksi</button>
              <br /> <br />
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="submit" name="cancel" style="margin-left: 100px;" type="button" class="btn btn-danger btn-lg">Batalkan Transaksi</button>
